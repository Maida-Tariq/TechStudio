      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center lg:items-start space-y-6 lg:space-y-0 mt-[-50px]">
        ...
        <div className="text-center lg:text-left lg:w-1/2 space-y-6 lg:mr-5 ml-[5%]">
          ...
          <div className="flex justify-center lg:justify-start space-x-4">
            <button className="px-4 py-3 bg-[#3E4E88] text-white rounded-md hover:bg-[#334B72] transition duration-300">
              Get Started
            </button>
        ...
        <div className="flex items-center lg:ml-20 mb-0 lg:mt-8" style={{ marginTop: '100px' }}>
          <div className="relative">
            <a
              href="#"
              className="hidden sm:flex items-center justify-center w-[200px] h-[200px] bg-[white] text-[#334B72] border-2 border-[#334B72] rounded-full shadow-md hover:bg-[#334B72] transition duration-300 hover:text-[white]"
            >
