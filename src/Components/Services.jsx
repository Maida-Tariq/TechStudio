    ...
    <section className="py-10 bg-white" data-aos="fade-up" data-aos-duration="1000">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-6 md:gap-8"> {/* Adjusted gaps */}
          ...
          {/* Service Item 2 - UX/UI Designing (Shorter Height) */}
          <div className="relative h-[200px] md:h-[300px] overflow-hidden rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 w-full md:w-[30%]"> {/* Use w-full for mobile */}
